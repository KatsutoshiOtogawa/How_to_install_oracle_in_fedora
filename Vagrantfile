...
Vagrant.configure("2") do |config|
    ...
    # this script is oracle launch.lsnrctl,oracle database is not service in fedora.
    # Therefor, when os launch, this script is always run. 
    config.vm.provision "shell", path: "./start_oracle.sh", run: "always"
